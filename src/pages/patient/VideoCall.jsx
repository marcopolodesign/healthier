...
export default function VideoCall({ profile }) {
  ...
  return (
    <div className="absolute inset-0 bg-black z-[110] flex flex-col animate-fade-in">
      ...
      {/* Inner wrapper — caps width on ultrawide */}
      <div className="relative z-10 max-w-5xl mx-auto w-full h-full flex flex-col">

      {/* Header bar */}
      <div className="pt-14 sm:pt-8 px-6 flex justify-between items-center">
      ...
      {/* Self view */}
      <div className="absolute top-32 sm:top-24 right-6 sm:right-8 w-28 sm:w-36 h-40 sm:h-48 bg-gray-800 rounded-2xl overflow-hidden border-2 border-white/30 shadow-2xl">
        <img
      ...
      {/* Controls */}
      <div className="mt-auto pb-12 sm:pb-8 px-8 flex justify-center items-center gap-6">
