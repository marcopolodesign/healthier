...
export default function PatientAIChat({ profile }) {
  ...
  return (
    <div className="absolute inset-0 flex flex-col">
      ...
      {/* Messages */}
      <div className="flex-1 overflow-y-auto px-4 patient-column pb-4 space-y-4">
        {messages.map((msg, i) => (
          <div key={i}>
      ...
      {/* Input bar */}
      <div className="px-4 patient-column pb-4 lg:pb-28 pt-3 border-t border-gray-100 bg-bg-secondary flex-shrink-0">
