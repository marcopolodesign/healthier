...
export default function PatientDashboard({ profile }) {
  ...
  return (
    <div className="absolute inset-0">
      ...
      {/* Location header */}
      <div className="absolute top-14 w-full px-6 z-30 flex justify-start items-center pointer-events-none">
        <div
          onClick={() => {}}
          className="flex flex-col bg-white/70 backdrop-blur-[20px] px-2 py-2 rounded-[20px] shadow-[0_8px_30px_rgba(0,0,0,0.06)] border border-white/50 pointer-events-auto cursor-pointer transition-all self-start max-w-[70%]"
        >
      ...
      >
        ...
        <div className="px-6 flex-1 overflow-y-auto pb-32 scrollbar-hide bg-white mt-2">
          {/* Vitals widgets */}
          <div className="flex gap-3 mb-5 py-1">
          ...
          {/* AI triage bar */}
          <div
            className={`bg-[#F8FAFC] p-4 rounded-[24px] flex flex-col gap-3 mb-6 shadow-sm border border-gray-100 transition-all focus-within:ring-2 focus-within:ring-blue-100 focus-within:border-blue-200 ${searchQuery ? 'border-blue-200 bg-blue-50/30' : ''}`}
            onClick={() => sheet.setState('expanded')}
          >
              ...
              <div className="bg-white p-4 rounded-xl border border-blue-100 shadow-sm mt-2 animate-fade-in relative overflow-hidden">
                ...
                <div className="flex gap-3 items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[11px] text-gray-400">*Consulta a un médico para diagnóstico exacto.*</p>
                    {(() => {
          ...
          {/* Expanded content */}
          <div className={`transition-all duration-500 ease-in-out overflow-hidden flex flex-col gap-4 ${sheet.state === 'expanded' ? 'max-h-[500px] opacity-100 mt-6 mb-8' : 'max-h-0 opacity-0 m-0'}`}>
            {/* SOS button */}
            <div
      ...
      {mapProFlow && selectedMapPro && (
        <div className="absolute inset-0 bg-gray-900/50 backdrop-blur-sm z-[80] flex flex-col justify-end animate-fade-in">
          <button
            ...
            className="absolute top-14 right-6 z-[90] w-10 h-10 bg-white border border-gray-200 shadow-sm rounded-full flex items-center justify-center hover:bg-gray-50"
          >
            ✕
          </button>
