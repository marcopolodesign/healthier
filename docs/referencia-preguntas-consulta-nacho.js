/**
 * REFERENCIA — contenido clínico del prototipo "Consola clínica / HCE sugerente"
 * que armó Nacho (CEO). Pasado por Mateo el 2026-08-07.
 *
 * ⚠️ ESTO ES UNA REFERENCIA, NO CÓDIGO EN USO. No lo importes desde `src/`.
 * Es la fuente de la que sale la pestaña de preguntas guiadas de la consulta.
 * El prototipo original era un HTML autocontenido con su propio CSS y su propio
 * render; nada de eso se porta — Healthier tiene su design system.
 *
 * Lo que sí importa es el contenido: por cada motivo de consulta hay
 *   q  → preguntas dirigidas para hacerle al paciente EN la llamada
 *   rf → banderas rojas (lo que hay que descartar)
 *   dx → diagnósticos diferenciales, con CIE-10 y un flag de urgencia (1 = urgente)
 *   ex → maniobras de examen sugeridas
 *   st → estudios sugeridos
 *
 * Es material de APOYO a la documentación y al razonamiento. No reemplaza el
 * juicio clínico ni constituye un diagnóstico — el propio prototipo lo aclara
 * en pantalla y esa aclaración tiene que sobrevivir al port.
 */
...
/** Revisión por sistemas — interrogatorio dirigido, agrupado por aparato. */
export const RXS = {
  "Constitucional": ["Fiebre", "Pérdida de peso", "Astenia", "Sudoración nocturna"],
  "Cardiovascular": ["Dolor torácico", "Palpitaciones", "Disnea de esfuerzo", "Edemas", "Síncope"],
  "Respiratorio": ["Tos", "Expectoración", "Disnea", "Hemoptisis", "Sibilancias"],
  "Digestivo": ["Náuseas/vómitos", "Dolor abdominal", "Diarrea", "Constipación", "Melena/hematoquecia"],
  "Genitourinario": ["Disuria", "Polaquiuria", "Hematuria", "Urgencia", "Alt. menstrual"],
  "Neurológico": ["Cefalea", "Mareo", "Déficit focal", "Convulsiones", "Parestesias"],
  "Musculoesquelético": ["Artralgias", "Mialgias", "Rigidez matinal", "Debilidad"],
  "Piel": ["Rash", "Prurito", "Lesiones nuevas", "Ictericia"],
  "Psiquiátrico": ["Ánimo depresivo", "Ansiedad", "Insomnio", "Ideación"],
  "Endocrino": ["Poliuria/polidipsia", "Intol. frío/calor", "Cambios de peso"],
}

/** Aparatos del examen físico, cada uno normal / alterado. */
export const SISTEMAS_EX = ["Estado general", "Piel y faneras", "Cabeza y cuello", "Cardiovascular", "Respiratorio", "Abdomen", "Genitourinario", "Neurológico", "Osteoarticular"]

/** Antecedentes personales y familiares, como chips de selección rápida. */
export const ANTEC_CHIPS = ["HTA", "Diabetes", "Dislipemia", "Asma", "EPOC", "Cardiopatía isquémica", "Insuf. cardíaca", "ERC", "Hepatopatía", "Hipotiroidismo", "ACV/AIT", "Cáncer", "Anticoagulación"]
export const FAM_CHIPS = ["Cardiopatía precoz", "Muerte súbita", "Diabetes", "Cáncer mama/colon", "HTA", "Enf. tiroidea"]

/**
 * Signos vitales con su rango de referencia. El prototipo marca en rojo el
 * valor fuera de rango y calcula IMC con peso y talla:
 *   TA    → sistólica ≥140 o diastólica ≥90 = elevada; sistólica <90 = baja
 *   FC    → <60 bradicardia, >100 taquicardia
 *   FR    → <12 bradipnea, >20 taquipnea
 *   T°    → ≥38 febril, <35 hipotermia
 *   SatO₂ → <95 hipoxemia
 *   IMC   → <18,5 bajo peso · <25 normal · <30 sobrepeso · ≥30 obesidad (OMS)
 */
export const VITALS = [
  ["ta", "TA", "120/80", "mmHg"],
  ["fc", "FC", "60–100", "lpm"],
...
/**
 * Otras ideas del prototipo que NO son parte del pedido de C1, anotadas para
 * no perderlas: armado automático del resumen SOAP a partir de lo cargado,
 * export del encuentro como Bundle FHIR, alerta cruzando la prescripción con
 * las alergias registradas del paciente, y un anillo de progreso de "cuántas
 * secciones de la historia están completas".
 */
